            ...
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    Row(
                        ...
                        Text("$${totalCarrito.toInt()}", style = MaterialTheme.typography.headlineSmall, fontWeight = FontWeight.Bold)
                    }
                ...
                Card(
                    ...
                    Column(modifier = Modifier.padding(12.dp)) {
                        Row(
                            ...
                            Text("$${medicamento.precio.toInt()}", style = MaterialTheme.typography.titleMedium)
                        }
